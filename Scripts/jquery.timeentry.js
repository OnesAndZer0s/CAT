...
(function($) { // Hide scope, no $ conflict
    ...
    $.extend(TimeEntry.prototype, {
        ...
        _connectTimeEntry: function(target, options) {
            ...
            // Check pastes
            if ($.browser.mozilla) {
                input.bind('input.timeEntry', function(event) {
        ...
        _doKeyDown: function(event) {
            ...
            switch (event.keyCode) {
                ...
                case 36:
                    ...
                    break;
                case 37:
                    $.timeEntry._changeField(inst, -1, false);
                    break; // Previous field on left
                case 38:
                    $.timeEntry._adjustField(inst, +1);
        ...
        _handleSpinner: function(event) {
            ...
            if (region >= 3 && spinnerRepeat[0]) { // Repeat increment/decrement
                $.timeEntry._timer = setTimeout(
                    function() {
                        $.timeEntry._repeatSpinner(inst, region);
                    },
                    spinnerRepeat[0]);
        ...
        _getSpinnerRegion: function(inst, event) {
            ...
            var scrolled = ($.browser.safari ? $.timeEntry._findScroll(spinner) : [document.documentElement.scrollLeft || document.body.scrollLeft,
        ...
        _setTime: function(inst, time) {
            ...
            var fields = this._constrainTime(inst, time ? [time.getHours(), time.getMinutes(), time.getSeconds()] : null);
            ...
            if (beforeSetTime) {
                time = beforeSetTime.apply(inst.input[0], [this._getTimeTimeEntry(inst.input[0]), time, minTime, maxTime]);
            }
